...
- This is a research POC (no build, no runtime; `experiments/` holds manual tool experiments). Question, verdict, and evidence map live in README.md
- Git: single `main` branch, no remote
